(function (n) {
    ...
    var t = { workerDir: "/", 
              ...
              encoding: "wav", 
              options: { 
                timeLimit: 300, encodeAfterRecord: false, progressInterval: 1e3, bufferSize: undefined, wav: { mimeType: "audio/wav" }, ogg: { mimeType: "audio/ogg", quality: .5 }, mp3: { mimeType: "audio/mpeg", bitRate: 160 } 
               }
            }; 
    var i = function (i, n) { 
        e(this, t, n || {}); 
    ...
    e(i.prototype, { 
        ...
        setEncoding: function (e) { 
            ...
            else if (this.encoding !== e) { this.encoding = e; this.initWorker()}}, 
        ...
        startRecording: function () { 
            ...
            else { var i = this.numChannels, e = this.buffer, n = this.worker; this.processor = this.context.createScriptProcessor(this.options.bufferSize, this.numChannels, this.numChannels); 
        ...
        cancelEncoding: function () { 
            ...
            else { this.onEncodingCanceled(this); this.initWorker() } else this.error("cancelEncoding: invalid method call") }, 
        initWorker: function () { 
